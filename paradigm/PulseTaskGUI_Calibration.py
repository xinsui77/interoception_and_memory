...
class PulseTaskGUI:
    ...
    def run_task(self, widget, data=None):
        ...
        if len(ID) == 0:
            ...
            #tell task_manager to open output file and run trials
    ...
    # add a screen at the beginning to show that the
    ...
    def display_trial(self, trial_number):
        ...
        self.trial_window.set_title("PULSE TASK TRIAL " + str(trial_number))
    ...
    def mark_response(self, widget, data):
        self.task_manager.curr_response = data
    ...
    def finished_task(self, is_done):
        ...
        if (is_done):
            screen_string = "Please start heartbeat discrimination task."
        else:
            screen_string = "Please repeat pulse familiarization."

        thanks = gtk.Label(screen_string)
