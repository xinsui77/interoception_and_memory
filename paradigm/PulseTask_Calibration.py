...
# Copy of HeartbeatDiscriminationTask for pulse task
...
from PulseTaskGUI_Calibration import *
...
#heartrate information during each trial
   ...
   #RUN TRIALS
    ...
    def run_trials(self, number_trials):
        ...
        correct = 0 #keep track of the number of correct guesses
        ...
        # Display prompt to move on if over 50% of guesses are correct (i.e. >number_trials)
